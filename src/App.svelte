...
>
  ...
  >
    ...
    <div class="flex items-center gap-3">
      ...
      <!-- Language Toggle (Pill Style Restored) -->
      <button
  ...
  {#if showSettings}
    <div class="fixed inset-0 z-50 flex items-center justify-center p-6">
      <div
        class="absolute inset-0 bg-[rgba(236,238,240,0.8)] dark:bg-[rgba(0,0,0,0.8)] backdrop-blur-xl transition-opacity duration-500"
        onclick={() => (showSettings = false)}
        aria-hidden="true"
      ></div>
      <div
        class="relative w-full max-w-2xl bg-[var(--glass-surface)] border border-[var(--glass-border)] rounded-[40px] shadow-2xl overflow-hidden h-[85vh] flex flex-col animate-in fade-in zoom-in-95 duration-300 backdrop-blur-2xl"
      >
